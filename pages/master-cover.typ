  ...
  stack(
    ...
    block(
      ...
      grid(
        ...
        info-key(if info.degree == "academic" { "专业" } else { "专业学位类别" }),
        info-value("major", info.major),
        info-key(if info.degree == "academic" { "研究方向" } else { "专业学位领域" }),
  ...
  stack(
    ...
    block(
      grid(
        ...
        en-info-key(if info.degree == "academic" { "Major:" } else { "Category:" }),
        en-info-value("major", info.major-en),
        en-info-key(if info.degree == "academic" { "Research Direction:" } else { "Field:" }),
